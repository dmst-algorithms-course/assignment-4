...
```
όπου `example.txt` ένα αρχείο κειμένου το οποίο περιέχει τους περιορισμούς με τη μορφή που αναφέρονται παραπάνω. ***Οι διαδικασίες θα μπορούν να έχουν οποιοδήποτε όνομα***, και όχι απαραίτητα `x1`, `x2`, κ.λπ. 
